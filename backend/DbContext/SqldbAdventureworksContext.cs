...
public partial class SqldbAdventureworksContext : DbContext
{
    private readonly string? _connectionString;

    public SqldbAdventureworksContext(string connectionString)
    {
        _connectionString = connectionString;
    }

    public SqldbAdventureworksContext(DbContextOptions<SqldbAdventureworksContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SystemInformationId).HasName("PK__BuildVer__35E58ECA6798EBD2");
